...
| _Open questions during drafting_ |
|---|
| Please check your name and job description at the bottom, perhaps nice to add something personal (see my example)? |
| This CfP assumes the structure is the same as last year, which is still undecided, is is the half/full day |
| There is an unencrypted version of our public room, created by Alexis, Upside of switching: Less issues (particularly for matrix self-hosters), people can read back all messages. Downsides: People can read back all messages, we have quite a big group of people in the current encrypted public channel, we have experience 1 issue with 1 user over last year. |



**The Bioinformatics and Computational Biology FOSDEM community is pleased to announce the return of our DevRoom and invites participants to submit proposals for talks for the event. It will take place on either January 30 or 31 in Belgium, at the [Université Libre de Bruxelles (ULB)](https://www.openstreetmap.org/relation/13699100#map=18/50.813724/4.382805), _exact time of th devroom to be determined_.**
...
<img src="pictures/2026/full_room_cropped.jpg" height="150">
<img src="pictures/2026/speaker_cropped.jpeg" height="150">
<img src="pictures/2026/room_forward_cropped.jpeg" height="150">

Following a successful Birds of a Feather session at FOSDEM 2025 and a very well visited [DevRoom track in 2026](https://archive.fosdem.org/2026/schedule/track/bioinformatics/), both drawing many attendees from diverse backgrounds, we're happy to announce the second installment of our Bioinformatics & Computational Biology devroom. It focuses on sharing and collaboration in the life sciences, covering:
...
- Go to [FOSDEM pretalx](https://pretalx.fosdem.org/fosdem-2027/cfp) website _Warning, currently not available yet_.
...
<img src="pictures/2026/team_2026_small.jpeg" width="454" alt="Image of the 2026 team">

_The 2026 team, FLTR:_

* Alessandro Pilotti - Open Source Cloud Computing and Bioinformatics
* Freek van Hemert - Next-Generation Sequencing Data Analysis and Infrastructure - Avid self-hoster and baker of sourdough bread
...
* Olga Kalinina (new 2027 member) - Professor in Bioinformatics
